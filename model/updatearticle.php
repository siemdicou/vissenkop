...
$databaseimg     =  $_POST['databaseimg'];
$databasephotos    =  $_POST['databasephotos'];
...
if (empty($_FILES["filess"]["name"][0])) {
    $newfilename = $databaseimg;
}else{
    ...
    $profilepicture = $_FILES["filess"]["name"][0];
